...
export default function Projects() {
  return (
    <section id="projects" style={{ minHeight: '100vh', padding: '6rem 1.5rem', backgroundColor: '#0D0F14' }}>
      <div style={{ maxWidth: '72rem', margin: '0 auto', width: '100%' }}>
        ...
        <h2 style={{ fontSize: '2.5rem', fontWeight: '700', color: '#E8EAF0', marginBottom: '5rem' }}>
          Things I&apos;ve built
        </h2>
          ...
          {projects.map((project, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div style={{ backgroundColor: '#161A23', border: '1px solid #252A36', borderRadius: '0.5rem', padding: '2rem' }}>
                    <h3 style={{ fontFamily: 'monospace', color: '#4FFFA4', fontSize: '1.1rem',
                      letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '1rem' }}>
                      {project.title}
                    </h3>

                    <p style={{ color: '#5A6072', fontSize: '0.95rem', lineHeight: '1.75', marginBottom: '1.5rem' }}>
                      {project.description}
                    </p>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '1.5rem' }}>
                      {project.tags.map((tag) => (
                        <span key={tag} style={{ fontFamily: 'monospace', fontSize: '0.75rem', color: '#4FFFA4',
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                      {project.github && (
                        <a href={project.github} target="_blank" rel="noopener noreferrer"
                          style={{ color: '#5A6072', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.875rem', transition: 'color 0.2s' }}
  ...
  {project.image ? (
    ...
    <span style={{ color: '#252A36', fontFamily: 'monospace', fontSize: '0.875rem',
